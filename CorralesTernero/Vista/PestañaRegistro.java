...
import de.craften.ui.swingmaterial.toast.Toast;
...
public class PestañaRegistro extends JPanel {
	...
	private void hazInterfaz() {
		...
		mensaje = new ToastBar();
		mensaje.setBounds(250, 430, 200, 50);
	...
	public void mensaje(String msg, boolean error) {
		if (error)
			Toast.BACKGROUND=MaterialColors.RED_500;
		else
			Toast.BACKGROUND=MaterialColors.GREEN_500;
		mensaje.display(new TextToast(msg));
	}
